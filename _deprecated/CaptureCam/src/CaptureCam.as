package
{
	...
	public class CaptureCam extends Sprite
	{
		...
		public function CaptureCam()
		{
			ExternalInterface.addCallback('start_recording', extStartRecording);
			ExternalInterface.addCallback('stop_recording', extStopRecording);
			
			this.stage.align = StageAlign.TOP_LEFT;
			this.stage.scaleMode = StageScaleMode.NO_SCALE;
			
			_output = new Sprite();
			_output.graphics.beginFill(0xffffff);
		...
		public function extStartRecording():void
		{
			if (_state == States.WAITING_FOR_RECORD) 
				setState(States.RECORDING);
		}
		
		public function extStopRecording():void
		{
			if (_state == States.RECORDING)
				setState(States.ENCODING);
		}
